...
<table class="w-full border-collapse border border-gray-300">
    ...
    <tr>
        ...
        <th class="border border-gray-300 p-2">Preu Mitjana Entrades</th>
        <th class="border border-gray-300 p-2">Aforo maxim</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr class="hover:bg-gray-100">
        ...
        <td class="border border-gray-300 p-2">{{ $estadi['mitjanaPreuEntrades'] }}</td>
        <td class="border border-gray-300 p-2">{{ $estadi['aforoMaxim'] }}</td>
    </tr>
    @endforeach
    </tbody>
